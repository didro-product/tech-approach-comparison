...
public class TestMyService {
    ...
    public void testDetermineValue_1() {
        ...
        String actualResult = testedInstance.determineValue(2, 3, "anyvalue");
        Assertions.assertEquals("anyvalue56", actualResult);
    }
    ...
    public void testDetermineValue_2() {
        ...
        Assertions.assertEquals("anyvalue20", actualResult);
    }
