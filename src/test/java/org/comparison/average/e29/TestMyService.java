...
public class TestMyService {
    ...
    public void testDetermineValue_1() {
        ...
        int actualResult = testedInstance.determineValue(9);
        Assertions.assertEquals(99, actualResult);
    }
    ...
    public void testDetermineValue_2() {
        ...
        MyService testedInstance = new MyService();
        int actualResult = testedInstance.determineValue(51);
        Assertions.assertEquals(103, actualResult);
    }
    ...
    public void testDetermineValue_3() {
        ...
        MyService testedInstance = new MyService();
        int actualResult = testedInstance.determineValue(30);
