package org.comparison.average.e06;
...
public class TestMyService {
    ...
    public void testDetermineValue_3() {
        ...
        MyService testedInstance = new MyService();
        String actualResult = testedInstance.determineValue("________", "anyvalue", 24, 2);
        Assertions.assertEquals("anyvaluenum", actualResult);
    }
    ...
    public void testDetermineValue_2() {
        ...
        MyService testedInstance = new MyService();
        String actualResult = testedInstance.determineValue("________", "anyvalue", 58, 2);
    ...
    public void testDetermineValue_4() {
        ...
        MyService testedInstance = new MyService();
        String actualResult = testedInstance.determineValue("________", "anyvalue", 98, 2);
